...
idx_t RowGroup::Count() const { return count_; }

idx_t RowGroup::CapacityLeft() const { return ROW_GROUP_SIZE - count_; }
...
void RowGroup::Append(DataChunk& chunk) { Append(chunk, 0, chunk.size()); }

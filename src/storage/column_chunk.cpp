...
const LogicalType& ColumnChunk::GetType() const { return type_; }

idx_t ColumnChunk::Count() const { return count_; }
...
bool ColumnChunk::HasZoneMap() const { return has_zone_map_; }

const Value& ColumnChunk::Min() const { return min_; }

const Value& ColumnChunk::Max() const { return max_; }
